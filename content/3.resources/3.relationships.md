...
In some cases, you want to force the presence of some relations on creation because the database constraint forces the presence of the relation.

You can require a relation by using:
```php
