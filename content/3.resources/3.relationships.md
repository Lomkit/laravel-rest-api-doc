...
For this relation we need to specify all the possible morph resources as a second argument.
...
In some cases you might want to constrain the relation on mutation, Laravel Rest Api offers you constraints such has `requiredOnCreation`, `prohibitedOnCreation`, `reauiredOnUpdate` and `prohibitedOnUpdate`
