...
Scopes corresponds to [Laravel's scopes](https://laravel.com/docs/eloquent#query-scopes). You'll need to [specify them in your resource](/resources/exposed-datas#scopes) first to allow their usage.
...
All fields specified here must be defined in the [fields method of your resource](/resources/exposed-datas#fields) first.
...
All limits specified here must be defined in the [limits method of your resource](/resources/exposed-datas#limits) first.
