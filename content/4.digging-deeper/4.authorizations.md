...
To restrict access to viewing, creating, updating, or deleting resources (or any other actions), Laravel Rest Api relies on Laravel's [authorization policies](https://laravel.com/docs/authorization#creating-policies).
...
It is possible that you may need to create additional authorizations (for example, to protect a specific action).  
Simply add the desired method to your Policy.  
Laravel REST API will take care of making this Gate available.
