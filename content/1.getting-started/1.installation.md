---
title: Installation
description: Implement Laravel Rest Api in your project
---
...
:::tip
The quickest way to get up and running is the `rest:quick-start` command — it scaffolds a resource, controller, and route registration in one step.
